...
st.sidebar.image("https://cdn.pixabay.com/photo/2016/08/20/17/58/olympic-games-1608127_960_720.png")
...
if user_menu == 'Medal Tally':
    st.sidebar.header("Medal Tally") #heading
...
if user_menu== 'Athlete-wise Analysis':
    ...
    x = []
    name = []
    famous_sports = famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
